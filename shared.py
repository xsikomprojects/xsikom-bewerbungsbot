...
H = ('<!DOCTYPE html><html lang="de"><head>'
     ...
     'input,textarea,select{background:rgba(10,14,26,0.6);border:1px solid var(--bd);color:var(--t1);padding:14px 18px;border-radius:12px;width:100%;margin-bottom:12px;font-size:14px}'
